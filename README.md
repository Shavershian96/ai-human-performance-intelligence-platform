...
[![Coverage](https://img.shields.io/badge/coverage-81%25-green?logo=pytest)](https://github.com/Shavershian96/ai-human-performance-intelligence-platform/actions)
...
| Testing | 89 tests at 81% coverage, covering circuit-breaker, backoff and train/serve feature parity |
...
| Test suite | ✅ 89 tests, 81% coverage, no live DB required |
...
| Tests | 89 Tests bei 81% Coverage, inkl. Circuit-Breaker, Backoff und Train/Serve-Parität |
...
| Testsuite | ✅ 89 Tests, 81% Coverage, ohne laufende DB |
